...
public class ApiOperatorDemo implements Watcher {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        zookeeper = new ZooKeeper(Constants.CONNECT_IPS, 5000, new ApiOperatorDemo());
     ...
     * 创建节点和子节点
     */
    private static void createChild() throws KeeperException, InterruptedException {
        String path = "/node11";
    ...
    private static void delete() throws InterruptedException, KeeperException {
        //删除节点
        zookeeper.delete("/authTest", -1);
        countDownLatch.await();
    }

    private static void createAndUpdate() throws KeeperException, InterruptedException {
        // 创建节点
     ...
     * 认证
     */
    private static void auth() throws KeeperException, InterruptedException {
        ACL acl = new ACL(ZooDefs.Perms.ALL, new Id("ip", "192.168.0.100"));
