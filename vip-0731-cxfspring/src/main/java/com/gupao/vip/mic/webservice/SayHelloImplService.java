 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://webservice.mic.vip.gupao.com/", wsdlLocation = "http://localhost:8080/vip/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://webservice.mic.vip.gupao.com/", "SayHelloImplService");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://webservice.mic.vip.gupao.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.mic.vip.gupao.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
